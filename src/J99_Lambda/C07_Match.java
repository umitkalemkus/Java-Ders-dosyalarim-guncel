...
public class C07_Match {
    public static void main(String[] args) {
        ...
        List<String> menu = new ArrayList<String>(Arrays.asList("küşleme", "küşleme", "küşleme", "soğanlı", "soğanlı",
                "soğanlı", "trileçe", "bicibici", "büryan", "welemen", "cacix", "kokerç", "yağlama", "güveç", "arabAşı", "tantuni"));
        ...
        // Tak : List elemanlarinin karakter sayisini 7 ve 7 'den az olma durumunu kontrol ediniz.->
