...
import projeler.kitapYonetimi01.Kitapcı_KitapEkle;

import java.util.Scanner;

public class ProjeKitapci {
    /*
     * ==================== PROJE==============================
    ...
    public static void main(String[] args) {
      ...
      do {
          ...
          System.out.println("Lutfen islem seciniz : cikmak icin 0'a basiniz");
          ...
          switch (islem){
              ...
              break;
              default:
                  System.out.println("Lutfen gecerli bir islem numarasini giriniz");
              break;
    ...
    private static void menu() {
        System.out.println("****** kitapci programi********");
        System.out.println(
           "1-kitap ekle\n" +
           "2-Numara ile kitap goruntule\n"+
           "3-Bilgi ile kitap goruntule\n"+
