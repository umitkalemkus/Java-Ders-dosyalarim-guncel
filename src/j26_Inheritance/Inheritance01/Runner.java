...
*/
    ...
    public static void main(String[] args) {
        ...
        Mammal m1 = new Mammal();
         m1.sutBeslenme(); //child mama class call
         m1.dogum(); //child mama class call
         m1.icme();//parent hayvancik clasiindan call
         m1.yeme();//parent hayvancik clasiindan call
         m1.hareket();//parent hayvancik clasiindan call
