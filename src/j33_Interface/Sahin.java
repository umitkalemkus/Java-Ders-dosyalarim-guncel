...
public class Sahin extends Tofas implements disDonanim, icDonanim, Lastik {//conc child class extens-> Tofas , impelemts->dısDonamım,icDonanım,Lastik
    ...
    public String sisLamp() {
        return disDonanim.super.sisLamp();
    }
