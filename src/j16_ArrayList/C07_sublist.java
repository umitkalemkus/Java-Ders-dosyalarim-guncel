...
public class C07_sublist {
    public static void main(String[] args) {
        ...
        // subList() -> listenen istenen list parcasını return eder..System.out.println("listSehir.subList(3,5) = " + listSehir.subList(3, 5));//3.4. index elemalnrı listi veririr [stockholm, Angara]
